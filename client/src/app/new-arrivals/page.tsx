  ...
  useEffect(() => {
    const fetchNewArrivals = async () => {
      try {
        ...
        const response = await fetch(`${apiUrl}/products?sort=-createdAt&limit=12`);
        if (response.ok) {
  ...
  return (
    <div className="min-h-screen bg-earth-cream py-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h1 className="text-4xl font-bold text-earth-dark mb-4">New Arrivals</h1>
        <p className="text-earth-olive mb-8">Check out our latest products</p>
        ...
        {products.length > 0 ? (
            ...
            {products.map((product) => (
              ...
              >
                <div className="relative h-64 bg-gray-100">
                  ...
                  <div className="absolute top-2 right-2 bg-earth-bronze text-white px-2 py-1 rounded text-sm font-semibold">
                    NEW
                  </div>
                </div>
                <div className="p-4">
          ...
          <div className="text-center py-12">
            <p className="text-earth-olive mb-4">No new arrivals at the moment</p>
